...
export default function LayoutBlack({ children }) {
  return (
    <div id="container" className="my-px40 max-w-full md:my-px40">
      <div
        id="nav"
        className="hidden md:block md:h-auto md:my-px60 md:mx-px20 md:w-auto md:min-w-px10"
      >
        <div
          id="nav-inner"
        ...
        >
          <ResponsiveCtx.Provider
            value={{ isResponsive: false, bgColorWhite: true }}
          >
            <Nav />
          </ResponsiveCtx.Provider>
        </div>
